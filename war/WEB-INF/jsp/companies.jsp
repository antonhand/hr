...
<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <div id="container">
      <div id="wb_Form1" style="position:absolute;left:0px;top:100px;width:1200px;height:93px;z-index:7;">
         <form:form modelAttribute="comp" method="post">
            <form:input path="name" id="Editbox4" style="position:absolute;left:0px;top:28px;width:1085px;height:26px;line-height:26px;font-size:14px;z-index:2;" value="" spellcheck="false"/>
      ...
      <form method="get" action="/hr/com.profile.htm" name="">
	      <select name="companyID" size="16" style="position:absolute;left:0px;top:193px;width:1202px;z-index:6;font-size:20px">
      ...
      <div id="wb_Form3" style="position:absolute;left:1080px;top:600px;width:120px;height:93px;z-index:7;">
         <form name="Form3" method="GET" action="<c:url value="/addCompany.htm"/>">
